...
class ProductController extends Controller
{
    ...
    public function add_product(){
        $this->AuthLogin();
        $cate_product = DB::table('tbl_category_product')->orderby('category_id','desc')->get(); //show danh mục where
        $brand_product = DB::table('tbl_brand')->orderby('brand_id','desc')->get(); // show nhà cung cấp
    ...
    public function save_product(Request $request){
        ...
        if($get_image){
            ...
            $new_image =  $name_image.rand(0,99).'.'.$get_image->getClientOriginalExtension();//kiểm tra có phải hình ảnh k 
            $get_image->move('public/uploads/product',$new_image); //lưu vào thư mục
