						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<form action="{{URL::to('/save-cart')}}" method="POST">
									...
									<div><span>{{number_format($value->product_price,0,',','.').'VNĐ'}}</span></div>
									<div><input name="qty" type="number" min="1" class="qty cart_product_qty_{{$value->product_id}}"  value="1" /></div>
									<div><input name="productid_hidden" type="hidden"  value="{{$value->product_id}}" /></div>
